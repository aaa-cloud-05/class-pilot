...
import { Bell, Inbox, Plus, X } from "lucide-react"
...
export default function HomePage() {
  ...
  const { now, assignments, controls, setAddOpen, setSyncOpen, notifications } = useMock()
        ...
        actions={
          <>
            ...
            <div className="relative lg:hidden">
              <IconButton icon={Bell} label="通知" onClick={() => router.push("/mock-v4/activity")} />
              {unread > 0 && (
                ...
                <EmptyState
                  ...
                  action={
                    <div className="flex gap-2">
                      <Button variant="primary" onClick={() => router.push("/mock-v4/start")}>
                        セットアップを開く
                      </Button>
