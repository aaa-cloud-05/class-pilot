...
const STORAGE_KEY = "uf-mock-v4-controls"
  ...
  return (
    <MockContext.Provider value={value}>
      ...
      <div
        ...
        data-density={mounted ? controls.density : undefined}
        data-jp={mounted ? controls.jp : undefined}
        className={`${fontClassName} min-h-dvh antialiased`}
      >
        <MotionConfig reducedMotion="user">{mounted ? children : null}</MotionConfig>
      </div>
