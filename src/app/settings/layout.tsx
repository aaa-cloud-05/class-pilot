...
const NAV: { href: string; label: string; icon: typeof Bell; exact?: boolean; match?: string }[] = [
  { href: "/settings", label: "アカウントと表示", icon: UserRound, exact: true },
  { href: "/settings/notifications", label: "通知", icon: Bell },
  { href: "/settings/courses", label: "コース", icon: Layers },
  { href: "/settings/setup", label: "セットアップ", icon: Plug },
  { href: "/settings/help", label: "ヘルプ", icon: BookOpen, match: "/settings/help" },
]
