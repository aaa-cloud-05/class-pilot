      ...
      <dl className="mt-5 space-y-2.5 border-y border-border py-4">
        <div className="flex items-baseline justify-between gap-3">
          ...
          <dd className="text-right">
            <span className="text-[15px] font-medium tabular-nums">{dueLong(a.due)}</span>
            {rel && <span className={cn("ml-2 text-[13px] font-semibold", TONE_TEXT[rel.tone])}>{rel.text}</span>}
          </dd>
        </div>
        <div className="flex items-baseline justify-between gap-3">
