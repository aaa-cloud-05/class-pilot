        ...
        <div className="space-y-7">
          {controls.loggedIn ? (
            ...
            <Card className="p-5">
              ...
              <ButtonLink href="/mock-v2/login" size="lg" className="mt-4 w-full">
          ...
          <ListGroup title="連携" className="lg:hidden">
            ...
            />
            <RowLink
              href="/mock-v2/settings/webclass"
              icon={Globe}
          ...
          <ListGroup title="通知とコース" className="lg:hidden">
            ...
            />
            <RowLink href="/mock-v2/settings/courses" icon={Layers} label="コース" detail={`${visibleCourses} コース`} />
          </ListGroup>
          ...
          <ListGroup title="ヘルプ" className="lg:hidden">
            <RowLink href="/mock-v2/help" icon={BookOpen} label="はじめかたと使い方" />
            <RowLink href="/mock-v2/help/safety" icon={Shield} label="安全性とよくある質問" />
          </ListGroup>
