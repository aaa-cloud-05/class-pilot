...
const NAV = [
  { href: "/mock-v2/settings", label: "アカウントと表示", icon: UserRound, exact: true },
  { href: "/mock-v2/settings/notifications", label: "通知", icon: Bell },
  { href: "/mock-v2/settings/courses", label: "コース", icon: Layers },
  { href: "/mock-v2/settings/webclass", label: "WebClass 連携", icon: Globe },
  { href: "/mock-v2/help", label: "ヘルプ", icon: BookOpen },
]
