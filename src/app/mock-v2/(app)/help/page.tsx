...
export default function MockHelpPage() {
  ...
  return (
    <>
      <MobileHeader variant="back" title="はじめかたと使い方" backHref="/mock-v2/settings" />
      <PageBody desktopTitle="はじめかたと使い方" desktopBack={{ href: "/mock-v2/settings", label: "設定" }}>
        <div className="space-y-7">
          ...
          <ListGroup title="使い方ガイド">
            ...
            />
            <RowLink href="/mock-v2/help/screen" icon={Eye} label="画面の見かた" description="色・丸チェック・カレンダー" />
            <RowLink href="/mock-v2/help/sync" icon={RefreshCw} label="同期のしくみ" description="いつ更新されるか・取得の上限" />
            <RowLink href="/mock-v2/help/safety" icon={Shield} label="安全性とよくある質問" description="何を読み取るか・困ったとき" />
          </ListGroup>
