...
import { Bell, BookOpen, Globe, Layers, UserRound } from "lucide-react"
import { cn } from "@/lib/utils"

const NAV = [
  { href: "/mock/settings", label: "アカウントと表示", icon: UserRound, exact: true },
  { href: "/mock/settings/notifications", label: "通知", icon: Bell },
  { href: "/mock/settings/courses", label: "コース", icon: Layers },
  { href: "/mock/settings/webclass", label: "WebClass 連携", icon: Globe },
  { href: "/mock/help", label: "ヘルプ", icon: BookOpen },
]
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    on ? "bg-surface text-ink shadow-card" : "text-ink-2 hover:bg-surface-2",
                  )}
                >
