...
const NAV = [
  { href: "/mock-v3/settings", label: "概要", exact: true },
  { href: "/mock-v3/settings/connections", label: "接続" },
  { href: "/mock-v3/settings/notifications", label: "通知" },
  { href: "/mock-v3/settings/courses", label: "コース" },
  { href: "/mock-v3/settings/account", label: "アカウント" },
  { href: "/mock-v3/settings/help", label: "ヘルプ" },
]
