      ...
      <div className="flex flex-1 flex-col justify-center py-10">
        {phase === "importing" && (
          <div aria-live="polite">
            <p className="text-[18px] font-semibold tracking-[-0.01em]">WebClass を取り込んでいます</p>
        ...
        {phase === "done" && (
          <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
            ...
            <p className="mt-4 text-[18px] font-semibold">12 件を取り込みました</p>
            <p className="mt-1 text-[13px] text-muted-foreground">新しい課題が 2 件、締切が変わった課題が 1 件あります。</p>
            <ButtonLink href="/mock-v3/home" variant="primary" size="lg" className="mt-5 w-full">
              ホームで見る
            </ButtonLink>
          </motion.div>
        )}
        ...
        {phase === "error" && (
          <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
            ...
            <p className="mt-4 text-[18px] font-semibold">取り込めませんでした</p>
            ...
            <div className="mt-5 flex gap-2">
              ...
              <ButtonLink href="/mock-v3/settings/help/webclass" size="lg">
                手順を見る
              </ButtonLink>
            </div>
          </motion.div>
