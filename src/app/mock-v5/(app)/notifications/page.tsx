...
export default function MockNotificationsPage() {
  ...
  return (
    <>
      <MobileHeader variant="back" title="通知" backHref="/mock-v5/home" actions={readAll} />
      <PageBody desktopTitle="通知" desktopActions={readAll}>
        ...
        <p className="mt-6 px-2 text-[13px] leading-relaxed text-muted-foreground">
          通知の受け取り方やタイミングは{" "}
          <Link href="/mock-v5/settings/notifications" className="font-semibold text-primary hover:underline">
            設定 › 通知
          </Link>{" "}
          で変えられます。
        </p>
