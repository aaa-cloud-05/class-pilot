...
export default function SetupPage() {
  ...
  return (
    <>
      <MobileHeader variant="back" title="セットアップ" backHref="/mock-v5/settings" />
        ...
        <div className="space-y-4">
          ...
          >
            ...
            {controls.loggedIn ? (
              <div className="flex flex-wrap gap-2">
                ...
                <Button variant="secondary" onClick={() => setControl("loggedIn", false)}>
                  ログアウト
                </Button>
              </div>
            ) : (
              <ButtonLink href="/mock-v5/login" size="lg">
                Google でログイン
              </ButtonLink>
            )}
          </Step>
          ...
          >
            ...
            <div className="space-y-3 border-t border-border pt-4">
              ...
              <Button onClick={() => showToast("コードをコピーしました（モック）")}>
            ...
            <div className="space-y-3 border-t border-border pt-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Button variant="secondary" disabled={!controls.loggedIn} onClick={() => setToken(issueToken())}>
              ...
              {!controls.loggedIn && <p className="text-[13px] text-muted-foreground">自動取り込みにはログインが必要です。</p>}
            </div>
              ...
              <RowStatic
                ...
                right={
                  notif.permission === "granted" ? (
                    <Button size="sm" variant="secondary" onClick={() => showToast("テスト通知を送りました（モック）")}>
                      テスト
                    </Button>
                  ) : (
          ...
          >
            ...
            <ButtonLink href="/mock-v5/settings/courses" variant="secondary">
              コースを開く
            </ButtonLink>
          </Step>
